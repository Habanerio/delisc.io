...
internal static class Mapper
{
    ...
    internal static LinkEntity? Map(Link? link)
    {
        ...
        var entity = new LinkEntity(
            ...
            link.Url,
            link.Title,
            createdById: new Guid(link.SubmittedById))
        {
    ...
    internal static T? Map<T>(LinkEntity? entity)
    {
        ...
        {
            var model = new Link(entity.Id, entity.Url, entity.CreatedById)
            {
                Description = entity.Description,
                Domain = entity.Domain,
                Keywords = entity.Keywords?.ToArray() ?? [],
