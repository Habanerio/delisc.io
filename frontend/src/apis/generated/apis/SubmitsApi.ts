...
export class SubmitsApi extends runtime.BaseAPI {
     ...
     */
    async apiV1SubmitPostRaw(requestParameters: ApiV1SubmitPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmitLinkResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SubmitLinkResponseFromJSON(jsonValue));
    }

    /**
     * Submits a single url
     */
    async apiV1SubmitPost(requestParameters: ApiV1SubmitPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmitLinkResponse> {
     ...
     */
    async apiV1SubmitsPostRaw(requestParameters: ApiV1SubmitsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmitLinkResponse>> {
     ...
     * Submits one or more urls
     */
    async apiV1SubmitsPost(requestParameters: ApiV1SubmitsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmitLinkResponse> {
